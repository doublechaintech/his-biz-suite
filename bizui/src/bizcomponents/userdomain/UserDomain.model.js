...
export default {
  ...
  effects: {
    ...
    *addUserWhiteList({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/userDomain/${id}/list/\UserWhiteListList/用户白名单+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateUserWhiteList({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/userDomain/${id}/list/\UserWhiteListList/用户白名单列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
    ...
    *addSecUser({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/userDomain/${id}/list/\SecUserList/安全用户+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateSecUser({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/userDomain/${id}/list/\SecUserList/安全用户列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
