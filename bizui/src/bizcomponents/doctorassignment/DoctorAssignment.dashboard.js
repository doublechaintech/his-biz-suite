...
const internalSettingListOf = doctorAssignment =>
  defaultSettingListOf(doctorAssignment, optionList);
    ...
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="医生">
        {doctorAssignment.doctor == null
          ...
          : `${doctorAssignment.doctor.displayName}(${doctorAssignment.doctor.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '医生',
              'doctor',
              DoctorAssignmentService.requestCandidateDoctor,
              DoctorAssignmentService.transferToAnotherDoctor,
              'anotherDoctorId',
      ...
      <Description term="部门">
        {doctorAssignment.department == null
          ? appLocaleName(userContext, 'NotAssigned')
          : `${doctorAssignment.department.displayName}(${doctorAssignment.department.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '部门',
              'department',
              DoctorAssignmentService.requestCandidateDepartment,
              DoctorAssignmentService.transferToAnotherDepartment,
              'anotherDepartmentId',
