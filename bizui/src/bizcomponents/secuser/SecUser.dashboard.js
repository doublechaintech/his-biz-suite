  ...
  render() {
    ...
    const cardsData = {cardsName:"Sec User",cardsFor: "secUser",
    	cardsSource: this.props.secUser,returnURL,displayName,
  		subItems: [
{name: 'userAppList', displayName:'User App',type:'userApp',count:userAppCount,addFunction: true, role: 'userApp', metaInfo: userAppListMetaInfo},
{name: 'loginHistoryList', displayName:'Login History',type:'loginHistory',count:loginHistoryCount,addFunction: true, role: 'loginHistory', metaInfo: loginHistoryListMetaInfo},
