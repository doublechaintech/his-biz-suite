...
export default {
  ...
  effects: {
    ...
    *addListAccess({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/userApp/${id}/list/\ListAccessList/访问列表+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateListAccess({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/userApp/${id}/list/\ListAccessList/访问列表列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
    ...
    *addObjectAccess({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/userApp/${id}/list/\ObjectAccessList/对象访问+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateObjectAccess({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/userApp/${id}/list/\ObjectAccessList/对象访问列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
