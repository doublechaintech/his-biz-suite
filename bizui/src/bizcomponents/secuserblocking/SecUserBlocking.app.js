    ...
    return (
      ...
      >
        <Menu.Item key="dashboard">
          <Link to={`/secUserBlocking/${this.props.secUserBlocking.id}/dashboard`}>
            <Icon type="dashboard" />
        ...
        <Menu.Item key="preference">
          <Link to={`/secUserBlocking/${this.props.secUserBlocking.id}/preference`}>
            <Icon type="setting" />
