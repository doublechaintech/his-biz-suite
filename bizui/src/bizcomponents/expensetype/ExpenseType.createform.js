...
import ExpenseTypeCreateFormBody from './ExpenseType.createformbody'
  ...
  render() {
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'expenseType',listName:appLocaleName(userContext,"List") },
      })
    }
	...
	return (
      <PageHeaderLayout
        ...
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('expense_type')}`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<ExpenseTypeCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
