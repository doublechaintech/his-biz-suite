...
export default {
  ...
  effects: {
    ...
    *addUserApp({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/secUser/${id}/list/\UserAppList/用户应用程序+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateUserApp({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/secUser/${id}/list/\UserAppList/用户应用程序列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
    ...
    *addLoginHistory({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/secUser/${id}/list/\LoginHistoryList/登录历史+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateLoginHistory({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/secUser/${id}/list/\LoginHistoryList/登录历史列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
