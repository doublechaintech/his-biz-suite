  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="更新时间">
        {moment(department.updateTime).format('YYYY-MM-DD')}
      </Description>
...
class DepartmentDashboard extends Component {
  ...
  render() {
    ...
    const {
      id,
      displayName,
      doctorAssignmentListMetaInfo,
      doctorScheduleListMetaInfo,
      doctorAssignmentCount,
      doctorScheduleCount,
    ...
    const cardsData = {
      cardsName: '部门',
      cardsFor: 'department',
      cardsSource: this.props.department,
      returnURL,
      displayName,
      subItems: [
        {
