<%@ page import='java.util.*,com.panfeng.his.*,com.panfeng.his.secuser.SecUser'%>
...
<sky:include page="com/panfeng/his/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/panfeng/his/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/panfeng/his/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/panfeng/his/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/panfeng/his/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
