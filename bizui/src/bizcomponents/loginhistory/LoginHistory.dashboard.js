        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '安全用户',
              'secUser',
              LoginHistoryService.requestCandidateSecUser,
              LoginHistoryService.transferToAnotherSecUser,
              'anotherSecUserId',
              loginHistory.secUser ? loginHistory.secUser.id : ''
            )
          }
