...
class UserDomainDashboard extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '用户域',
      cardsFor: 'userDomain',
      cardsSource: this.props.userDomain,
      returnURL,
      displayName,
      subItems: [
        {
          ...
          renderItem: GlobalComponents.SecUserBase.renderItemOfList,
        },
      ],
    };
