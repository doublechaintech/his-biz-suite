<%@ page import='java.util.*,com.panfeng.his.*,com.panfeng.his.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/panfeng/his/secuserblocking/SecUserBlocking$Summary.jsp" />
