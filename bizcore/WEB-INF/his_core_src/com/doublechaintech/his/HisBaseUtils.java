...
public class HisBaseUtils {
	...
	public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(HisUserContext userContext,
	...
	private static <T extends BaseEntity> void collectReferedObjectIdSet(HisUserContext userContext,
     ...
     * "x-app-version" : "9"
	 */
	public static String getRequestAppVersion(HisUserContext userContext) {
		return userContext.getRequestHeader("x-app-version");
	}
	public static String getRequestAppDevice(HisUserContext userContext) {
