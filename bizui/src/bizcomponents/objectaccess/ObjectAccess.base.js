    ...
    <div key={objectAccess.id}>
      <DescriptionList key={objectAccess.id} size="small" col="4">
        ...
        <Description term="应用程序">
          {objectAccess.app == null
            ? appLocaleName(userContext, 'NotAssigned')
            : `${objectAccess.app.displayName}(${objectAccess.app.id})`}
        </Description>
      </DescriptionList>
