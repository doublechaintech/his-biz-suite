...
const displayColumns = [
  ...
  {
    title: fieldLabels.doctor,
    dataIndex: 'doctor',
    render: (text, record) => renderReferenceCell(text, record),
    sorter: true,
  },
  {
    title: fieldLabels.scheduleDate,
    dataIndex: 'scheduleDate',
    render: (text, record) => renderDateCell(text, record),
    sorter: true,
  },
  {
    title: fieldLabels.period,
    dataIndex: 'period',
    render: (text, record) => renderReferenceCell(text, record),
    sorter: true,
  },
