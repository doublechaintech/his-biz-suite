    ...
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="医生">
        {doctorSchedule.doctor == null
          ...
          : `${doctorSchedule.doctor.displayName}(${doctorSchedule.doctor.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '医生',
              'doctor',
              DoctorScheduleService.requestCandidateDoctor,
              DoctorScheduleService.transferToAnotherDoctor,
              'anotherDoctorId',
              doctorSchedule.doctor ? doctorSchedule.doctor.id : ''
            )
          }
          style={{ fontSize: 20, color: 'red' }}
        />
      </Description>
      <Description term="安排日期">
        {moment(doctorSchedule.scheduleDate).format('YYYY-MM-DD')}
      </Description>
      <Description term="期">
        {doctorSchedule.period == null
          ? appLocaleName(userContext, 'NotAssigned')
          : `${doctorSchedule.period.displayName}(${doctorSchedule.period.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '期',
              'period',
              DoctorScheduleService.requestCandidatePeriod,
              DoctorScheduleService.transferToAnotherPeriod,
              'anotherPeriodId',
              doctorSchedule.period ? doctorSchedule.period.id : ''
            )
          }
          style={{ fontSize: 20, color: 'red' }}
        />
      ...
      <Description term="部门">
        {doctorSchedule.department == null
          ? appLocaleName(userContext, 'NotAssigned')
          : `${doctorSchedule.department.displayName}(${doctorSchedule.department.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '部门',
              'department',
              DoctorScheduleService.requestCandidateDepartment,
              DoctorScheduleService.transferToAnotherDepartment,
              'anotherDepartmentId',
              doctorSchedule.department ? doctorSchedule.department.id : ''
            )
          }
          style={{ fontSize: 20, color: 'red' }}
        />
      ...
      <Description term="费用类型">
        {doctorSchedule.expenseType == null
          ? appLocaleName(userContext, 'NotAssigned')
          : `${doctorSchedule.expenseType.displayName}(${doctorSchedule.expenseType.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '费用类型',
              'expenseType',
              DoctorScheduleService.requestCandidateExpenseType,
              DoctorScheduleService.transferToAnotherExpenseType,
              'anotherExpenseTypeId',
              doctorSchedule.expenseType ? doctorSchedule.expenseType.id : ''
            )
          }
          style={{ fontSize: 20, color: 'red' }}
        />
      ...
      <Description term="创建时间">
        {moment(doctorSchedule.createTime).format('YYYY-MM-DD')}
      </Description>
      <Description term="更新时间">
        {moment(doctorSchedule.updateTime).format('YYYY-MM-DD')}
      </Description>
