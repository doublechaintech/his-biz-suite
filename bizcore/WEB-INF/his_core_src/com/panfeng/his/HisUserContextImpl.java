...
import com.panfeng.his.secuser.SecUserCustomManagerImpl;
...
public class HisUserContextImpl extends UserContextImpl implements HisUserContext{
	...
	static final String RESOURCE_PATH="com.panfeng.his.HisResources";
	static final String CUSTOM_RESOURCE_PATH="com.panfeng.his.HisCustomResources";
    ...
    /*
    public static SecUser getSecUser(HisUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(HisUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(HisUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(HisUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
