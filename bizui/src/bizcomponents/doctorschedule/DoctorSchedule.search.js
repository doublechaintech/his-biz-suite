  ...
  return (
    <div className={styles.tableListOperator}>
      ...
      {hasUpdatePermission(metaInfo) && (
        <Button onClick={() => handleUpdate(targetComponent)} icon="update" disabled={disable}>
  ...
  return (
    <div>
      <DoctorAssociateForm
        ...
        data={{ doctorScheduleList: selectedRows }}
        owner={owner}
...
class DoctorScheduleSearch extends PureComponent {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout
        title={`${displayName}:${this.props.name}${appLocaleName(userContext, 'List')}`}
      >
        <Card bordered={false}>
