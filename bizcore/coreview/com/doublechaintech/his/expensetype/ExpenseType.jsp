<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.expensetype.ExpenseType'%>
...
<c:set var="ownerBeanName" value="expenseType" scope="request"/>
<c:set var="ownerClassName" value="ExpenseType" scope="request"/>
...
<div class="row">
	...
	<% ExpenseType result = (ExpenseType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="expenseType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/his/expensetype/ExpenseType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/his/hospital/Hospital$Info.jsp" />
		...
		<div id="expenseItemList" class="tab-pane fade sublist" refer-name="expense_type">
			<sky:include page="com/doublechaintech/his/expenseitem/ExpenseItem$List.jsp"
					referName="expenseType"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["doctorScheduleList"] or ignoreListAccessControl}'>
		...
		<div id="doctorScheduleList" class="tab-pane fade sublist" refer-name="expense_type">
