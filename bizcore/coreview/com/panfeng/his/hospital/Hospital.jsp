<%@ page import='java.util.*,com.panfeng.his.*,com.panfeng.his.hospital.Hospital'%>
...
<sky:include page="com/panfeng/his/hospital/Hospital$Summary.jsp" />
		...
		<div id="expenseTypeList" class="tab-pane fade sublist" refer-name="hospital">
			<sky:include page="com/panfeng/his/expensetype/ExpenseType$List.jsp"
					referName="hospital"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["expenseItemList"] or ignoreListAccessControl}'>
		...
		<div id="expenseItemList" class="tab-pane fade sublist" refer-name="hospital">
			<sky:include page="com/panfeng/his/expenseitem/ExpenseItem$List.jsp"
					referName="hospital"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["doctorList"] or ignoreListAccessControl}'>
		...
		<div id="doctorList" class="tab-pane fade sublist" refer-name="hospital">
			<sky:include page="com/panfeng/his/doctor/Doctor$List.jsp"
					referName="hospital"/>
		</div>
	</c:if>
