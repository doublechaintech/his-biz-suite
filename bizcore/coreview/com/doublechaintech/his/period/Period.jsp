<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.period.Period'%>
...
<c:set var="ownerBeanName" value="period" scope="request"/>
<c:set var="ownerClassName" value="Period" scope="request"/>
...
<div class="row">
	...
	<% Period result = (Period)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="period" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/his/period/Period$Summary.jsp" />
...
<sky:include page="com/doublechaintech/his/hospital/Hospital$Info.jsp" />
		...
		<div id="doctorScheduleList" class="tab-pane fade sublist" refer-name="period">
