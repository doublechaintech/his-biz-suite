...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'userApp'),
    sorter: true,
  },
  {
  ...
  {
    title: fieldLabels.fullAccess,
    dataIndex: 'fullAccess',
    render: (text, record) => renderBooleanCell(text, record),
    sorter: true,
  },
  {
    title: fieldLabels.permission,
    debugtype: 'string',
