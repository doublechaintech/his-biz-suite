...
class HospitalPermission extends Component {
  ...
  render() {
    ...
    const cardsData = {
      cardsName: '医院',
      cardsFor: 'hospital',
      cardsSource: hospital,
      subItems: [
        {
          name: 'expenseTypeList',
          displayName: '费用类型',
          type: 'expenseType',
          count: expenseTypeCount,
          addFunction: true,
          role: 'expenseType',
          data: hospital.expenseTypeList,
        },
        {
          name: 'periodList',
          displayName: '期',
