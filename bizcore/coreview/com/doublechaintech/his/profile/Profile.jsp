<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.profile.Profile'%>
...
<div class="row">
	...
	<% Profile result = (Profile)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#registrationListAsPatient" class="disabled"> ${userContext.localeMap['registration']}</a></li>
			<li><a data-toggle="tab" href="#registrationListAsRegister" class="disabled"> ${userContext.localeMap['registration']}</a></li>
...
<sky:include page="com/doublechaintech/his/profile/Profile$Summary.jsp" />
...
<sky:include page="com/doublechaintech/his/platform/Platform$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["registrationListAsPatient"] or ignoreListAccessControl}'>
		<c:set var="registrationList" value="${result.registrationListAsPatient}" scope="request"/>
		<c:set var="registrationListName" value="registrationListAsPatient" scope="request"/>
		<div id="registrationListAsPatient" class="tab-pane fade sublist" refer-name="patient">
			<sky:include page="com/doublechaintech/his/registration/Registration$List.jsp"
					referName="patient"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["registrationListAsRegister"] or ignoreListAccessControl}'>
		<c:set var="registrationList" value="${result.registrationListAsRegister}" scope="request"/>
		<c:set var="registrationListName" value="registrationListAsRegister" scope="request"/>
		<div id="registrationListAsRegister" class="tab-pane fade sublist" refer-name="register">
			<sky:include page="com/doublechaintech/his/registration/Registration$List.jsp"
					referName="register"/>
		</div>
	</c:if>
