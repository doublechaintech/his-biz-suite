...
<Description term="要求">{formField.required}</Description> 
<Description term="禁用">{formField.disabled}</Description> 
<Description term="自定义渲染">{formField.customRendering}</Description> 
