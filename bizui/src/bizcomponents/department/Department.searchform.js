...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`departmentList.searchField`] = fieldName
    value[`departmentList.searchVerb`] =  searchVerb
    value[`departmentList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['departmentList'] = 1
      params['departmentList.orderBy.0'] = "id"
      params['departmentList.descOrAsc.0'] = "desc"
