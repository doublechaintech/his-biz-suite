...
import com.panfeng.his.hospital.CandidateHospital;
...
public class ExpenseTypeManagerImpl extends CustomHisCheckerManager implements ExpenseTypeManager {
 ...
 //--------------------------------------------------------------
	...
	*/
	...
	protected void checkParamsForAddingDoctorSchedule(HisUserContext userContext, String expenseTypeId, String name, Date scheduleDate, String period, String doctorId, int available, BigDecimal price, String departmentId,String [] tokensExpr) throws Exception{
	...
	{	
		...
		checkParamsForAddingDoctorSchedule(userContext,expenseTypeId,name, scheduleDate, period, doctorId, available, price, departmentId,tokensExpr);
		
		DoctorSchedule doctorSchedule = createDoctorSchedule(userContext,name, scheduleDate, period, doctorId, available, price, departmentId);
	...
	protected void checkParamsForUpdatingDoctorScheduleProperties(HisUserContext userContext, String expenseTypeId,String id,String name,Date scheduleDate,String period,int available,BigDecimal price,String [] tokensExpr) throws Exception {
	...
	public  ExpenseType updateDoctorScheduleProperties(HisUserContext userContext, String expenseTypeId, String id,String name,Date scheduleDate,String period,int available,BigDecimal price, String [] tokensExpr) throws Exception
	{	
		checkParamsForUpdatingDoctorScheduleProperties(userContext,expenseTypeId,id,name,scheduleDate,period,available,price,tokensExpr);
	...
	protected DoctorSchedule createDoctorSchedule(HisUserContext userContext, String name, Date scheduleDate, String period, String doctorId, int available, BigDecimal price, String departmentId) throws Exception{
