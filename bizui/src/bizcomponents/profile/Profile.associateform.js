...
class ProfileAssociateForm extends Component {
 ...
 <Modal
        ...
        <Card title={appLocaleName(userContext,"BasicInfo")}  className={styles.card} style={{ backgroundColor:"#eee" }}>
          <Form >
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={12}>
                <Form.Item label={fieldLabels.identificationNumber} {...formItemLayout}>
                  {getFieldDecorator('identificationNumber', {
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
                    <Input placeholder="请输入Identification Number" />
                  )}
                </Form.Item>
              </Col>
	...
	<RegistrationModalTable data={data.registrationListAsPatient} owner={owner} />
	<RegistrationModalTable data={data.registrationListAsRegister} owner={owner} />
