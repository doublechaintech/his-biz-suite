...
public class DepartmentManagerImpl extends CustomHisCheckerManager implements DepartmentManager {
 ...
 //--------------------------------------------------------------
	...
	*/
	...
	protected void checkParamsForAddingDoctorSchedule(HisUserContext userContext, String departmentId, String name, Date scheduleDate, String period, String doctorId, int available, BigDecimal price, String expenseTypeId,String [] tokensExpr) throws Exception{
	...
	{	
		...
		checkParamsForAddingDoctorSchedule(userContext,departmentId,name, scheduleDate, period, doctorId, available, price, expenseTypeId,tokensExpr);
		
		DoctorSchedule doctorSchedule = createDoctorSchedule(userContext,name, scheduleDate, period, doctorId, available, price, expenseTypeId);
	...
	protected void checkParamsForUpdatingDoctorScheduleProperties(HisUserContext userContext, String departmentId,String id,String name,Date scheduleDate,String period,int available,BigDecimal price,String [] tokensExpr) throws Exception {
	...
	public  Department updateDoctorScheduleProperties(HisUserContext userContext, String departmentId, String id,String name,Date scheduleDate,String period,int available,BigDecimal price, String [] tokensExpr) throws Exception
	{	
		checkParamsForUpdatingDoctorScheduleProperties(userContext,departmentId,id,name,scheduleDate,period,available,price,tokensExpr);
	...
	protected DoctorSchedule createDoctorSchedule(HisUserContext userContext, String name, Date scheduleDate, String period, String doctorId, int available, BigDecimal price, String expenseTypeId) throws Exception{
