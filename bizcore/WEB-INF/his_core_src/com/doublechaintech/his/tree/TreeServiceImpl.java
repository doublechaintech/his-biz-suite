...
public class TreeServiceImpl extends CustomHisCheckerManager implements TreeService {

    @Override
    public Node loadTree(HisUserContext ctx, String nodeId, String nodeType) throws Exception {
    ...
    @Override
    public Node loadAncestors(HisUserContext ctx, String nodeId, String nodeType) throws Exception {
        SmartList<TreeNode> nodes = loadTreeNode(ctx, nodeId, nodeType);
    ...
    public SmartList<TreeNode> loadTreeNode(HisUserContext ctx, String nodeId, String nodeType) {
     ...
     * @throws Exception
     */
    private <T extends BaseEntity> Node<T> extractTreeFromRoot(HisUserContext ctx, TreeNode pRoot) throws Exception {
    ...
    private <T extends BaseEntity> Node<T> extractAncestors(HisUserContext ctx, TreeNode pNode) throws Exception {
    ...
    @Override
    public Node addChild(HisUserContext ctx, Node nodeTree, String childId, String childType) throws Exception {
    ...
    public Node ensureRoot(HisUserContext ctx) throws Exception {
    ...
    @Override
    public Node deleteChild(HisUserContext ctx, Node parent, Node child) throws Exception {
        //do nothing
    ...
    private Node buildInternalTree(HisUserContext ctx, final List<TreeNode> pTreeNodes) throws Exception {
