<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.doctorassignment.DoctorAssignment'%>
...
<c:set var="ownerBeanName" value="doctorAssignment" scope="request"/>
<c:set var="ownerClassName" value="DoctorAssignment" scope="request"/>
...
<div class="row">
	...
	<% DoctorAssignment result = (DoctorAssignment)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="doctorAssignment" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/his/doctorassignment/DoctorAssignment$Summary.jsp" />
