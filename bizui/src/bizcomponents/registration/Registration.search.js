...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	visible={currentAssociateModal==='patient'} 
	data={{registrationListAsPatient:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'patient')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'patient')}/> <ProfileAssociateForm 
	visible={currentAssociateModal==='register'} 
	data={{registrationListAsRegister:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'register')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'register')}/> <PlatformAssociateForm 
