...
class DoctorAssignmentSearchForm extends PureComponent {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`doctorAssignmentList.searchField`] = fieldName;
    value[`doctorAssignmentList.searchVerb`] = searchVerb;
    value[`doctorAssignmentList.searchValue`] = fieldValue;
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['doctorAssignmentList'] = 1;
      params['doctorAssignmentList.orderBy.0'] = 'id';
      params['doctorAssignmentList.descOrAsc.0'] = 'desc';
