<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.platform.Platform'%>
...
<sky:include page="com/doublechaintech/his/platform/Platform$Summary.jsp" />
		...
		<div id="doctorList" class="tab-pane fade sublist" refer-name="platform">
	...
	<c:if test='${not empty userContext.accessTokens["profileList"] or ignoreListAccessControl}'>
		...
		<div id="profileList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/his/profile/Profile$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["registrationList"] or ignoreListAccessControl}'>
		...
		<div id="registrationList" class="tab-pane fade sublist" refer-name="platform">
