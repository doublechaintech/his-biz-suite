...
const menuData = {menuName:"Department", menuFor: "department",
  		subItems: [
...
const displayColumns = [
  { title: 'Id', debugtype: 'string', dataIndex: 'id', width: '20', render: (text, record)=>renderTextCell(text,record,'department') },
...
const DepartmentBase={menuData,displayColumns,fieldLabels}
