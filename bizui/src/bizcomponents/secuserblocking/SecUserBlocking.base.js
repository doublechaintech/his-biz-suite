...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'secUserBlocking'),
    sorter: true,
  },
  {
    title: fieldLabels.who,
    debugtype: 'string',
    dataIndex: 'who',
    width: '17',
  ...
  {
    title: fieldLabels.blockTime,
    dataIndex: 'blockTime',
    render: (text, record) => renderDateTimeCell(text, record),
    sorter: true,
  },
  {
    title: fieldLabels.comments,
    debugtype: 'string',
    dataIndex: 'comments',
    width: '28',
    render: (text, record) => renderTextCell(text, record),
