...
class ExpenseTypeUpdateForm extends Component {
  ...
  render() {
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}费用类型: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
	...
	return (
      ...
      >
       ...
       <Card title={window.trans('expense_type')} className={styles.card} bordered={false}>
          <Form >
          	<Row gutter={16}> 
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
