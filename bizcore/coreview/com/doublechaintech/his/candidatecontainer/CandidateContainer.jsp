<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.candidatecontainer.CandidateContainer'%>
...
<sky:include page="com/doublechaintech/his/candidatecontainer/CandidateContainer$Summary.jsp" />
		...
		<div id="candidateElementList" class="tab-pane fade sublist" refer-name="container">
			<sky:include page="com/doublechaintech/his/candidateelement/CandidateElement$List.jsp"
					referName="container"/>
		</div>
	</c:if>
