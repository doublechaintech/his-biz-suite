...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`registrationList.searchField`] = fieldName
    value[`registrationList.searchVerb`] =  searchVerb
    value[`registrationList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'patient'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'register'))
      ...
      params['registrationList'] = 1
      params['registrationList.orderBy.0'] = "id"
      params['registrationList.descOrAsc.0'] = "desc"
