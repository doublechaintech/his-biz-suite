<%@ page import='java.util.*,com.panfeng.his.*,com.panfeng.his.userapp.UserApp'%>
...
<sky:include page="com/panfeng/his/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/panfeng/his/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/panfeng/his/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/panfeng/his/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
