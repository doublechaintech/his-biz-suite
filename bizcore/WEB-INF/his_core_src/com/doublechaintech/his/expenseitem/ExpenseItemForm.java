...
public class ExpenseItemForm extends BaseForm {
	...
	public ExpenseItemForm updateTimeField(String parameterName, String initValue){
		FormField field = updateTimeFromExpenseItem(parameterName, initValue);		
		this.addFormField(field);
		return this;
	}
	
	public ExpenseItemForm updateTimeField(String initValue){
		return updateTimeField("updateTime",initValue);
	}
	public ExpenseItemForm updateTimeField(){
	...
	public ExpenseItemForm updateTimeFieldOfExpenseType(String parameterName, String initValue){
		FormField field =  updateTimeFromExpenseType(parameterName, initValue);
		this.addFormField(field);	
		return this;
	}
	
	public ExpenseItemForm updateTimeFieldOfExpenseType(String initValue){
		return updateTimeFieldOfExpenseType("updateTime",initValue);
	}
	public ExpenseItemForm updateTimeFieldOfExpenseType(){
