<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.mobileapp.MobileApp'%>
...
<sky:include page="com/doublechaintech/his/mobileapp/MobileApp$Summary.jsp" />
		...
		<div id="pageList" class="tab-pane fade sublist" refer-name="mobile_app">
			<sky:include page="com/doublechaintech/his/page/Page$List.jsp"
					referName="mobileApp"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["pageTypeList"] or ignoreListAccessControl}'>
		...
		<div id="pageTypeList" class="tab-pane fade sublist" refer-name="mobile_app">
			<sky:include page="com/doublechaintech/his/pagetype/PageType$List.jsp"
					referName="mobileApp"/>
		</div>
	</c:if>
