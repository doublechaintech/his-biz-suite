...
class UserDomainBizApp extends React.PureComponent {
    ...
    return (
      ...
      >
        ...
        <Menu.Item key="preference">
          <Link to={`/userDomain/${this.props.userDomain.id}/preference`}>
            <Icon type="setting" />
  ...
  getUserWhiteListSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        ...
        listName: 'userWhiteListList',
        ref: state._userDomain,
  ...
  buildRouters = () => {
    ...
    const routers = [
      ...
      {
        path: '/userDomain/:id/list/userWhiteListCreateForm',
        component: this.getUserWhiteListCreateForm(),
      },
      {
        path: '/userDomain/:id/list/userWhiteListUpdateForm',
        component: this.getUserWhiteListUpdateForm(),
      },
