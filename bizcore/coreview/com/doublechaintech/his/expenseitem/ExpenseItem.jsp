<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.expenseitem.ExpenseItem'%>
...
<c:set var="ownerBeanName" value="expenseItem" scope="request"/>
<c:set var="ownerClassName" value="ExpenseItem" scope="request"/>
...
<div class="row">
	...
	<% ExpenseItem result = (ExpenseItem)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="expenseItem" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/his/expenseitem/ExpenseItem$Summary.jsp" />
