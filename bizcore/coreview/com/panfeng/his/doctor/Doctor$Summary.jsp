...
<div class="col-xs-12 col-md-12 section">
	<b title="A Doctor"> 
		${userContext.localeMap['doctor']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['doctor.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
