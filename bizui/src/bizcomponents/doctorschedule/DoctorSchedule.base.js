...
<<<<<<< HEAD
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '20',render: (text, record)=>renderTextCell(text,record), sorter:true,sortOrder:"ascend" },
  { title: fieldLabels.name, debugtype: 'string', dataIndex: 'name', width: '33',render: (text, record)=>renderTextCell(text,record), sorter:true },
  ...
  { title: fieldLabels.available, debugtype: 'int', dataIndex: 'available', width: '6',render: (text, record)=>renderTextCell(text,record), sorter:true },
...
=======
  ...
  { title: fieldLabels.scheduleDate, dataIndex: 'scheduleDate', render: (text, record) =>renderDateCell(text,record) },
