...
<Description term="要求" style={{wordBreak: 'break-all'}}>{formField.required}</Description> 
<Description term="禁用" style={{wordBreak: 'break-all'}}>{formField.disabled}</Description> 
<Description term="自定义渲染" style={{wordBreak: 'break-all'}}>{formField.customRendering}</Description> 
