<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/his/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/his/userdomain/UserDomain$Info.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/his/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
