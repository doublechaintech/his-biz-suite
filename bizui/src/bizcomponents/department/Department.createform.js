  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addDepartment`,
          payload: { id: owner.id, type: 'department', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'department',listName:appLocaleName(userContext,"List") },
      })
    }
...
}))(Form.create()(DepartmentCreateForm))
