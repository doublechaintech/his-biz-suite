...
public class DoctorTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_SHOT_IMAGE,COLUMN_HOSPITAL,COLUMN_UPDATE_TIME,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_SHOT_IMAGE,COLUMN_HOSPITAL,COLUMN_UPDATE_TIME};
