...
public class Department extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="Department";
	...
	public Department updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public Department updateHospital(Hospital hospital){
		this.mHospital = hospital;;
		this.changed = true;
		return this;
	}
	...
	public Department updateUpdateTime(DateTime updateTime){
		this.mUpdateTime = updateTime;;
		this.changed = true;
		return this;
	}
	...
	public Department updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  void setDoctorAssignmentList(SmartList<DoctorAssignment> doctorAssignmentList){
		for( DoctorAssignment doctorAssignment:doctorAssignmentList){
			doctorAssignment.setDepartment(this);
		}
	...
	public  DoctorAssignment removeDoctorAssignment(DoctorAssignment doctorAssignmentIndex){
        ...
        // doctorAssignment.clearDepartment(); //disconnect with Department
        doctorAssignment.clearFromAll(); //disconnect with Department
	...
	public  void breakWithDoctorAssignment(DoctorAssignment doctorAssignment){
		...
		doctorAssignment.setDepartment(null);
	...
	public  void setDoctorScheduleList(SmartList<DoctorSchedule> doctorScheduleList){
		for( DoctorSchedule doctorSchedule:doctorScheduleList){
			doctorSchedule.setDepartment(this);
		}
	...
	public  DoctorSchedule removeDoctorSchedule(DoctorSchedule doctorScheduleIndex){
        ...
        // doctorSchedule.clearDepartment(); //disconnect with Department
        doctorSchedule.clearFromAll(); //disconnect with Department
	...
	public  void breakWithDoctorSchedule(DoctorSchedule doctorSchedule){
		...
		doctorSchedule.setDepartment(null);
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof Department){
		
		
			Department dest =(Department)baseDest;
