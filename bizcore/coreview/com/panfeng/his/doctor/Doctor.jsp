<%@ page import='java.util.*,com.panfeng.his.*,com.panfeng.his.doctor.Doctor'%>
...
<c:set var="ownerBeanName" value="doctor" scope="request"/>
<c:set var="ownerClassName" value="Doctor" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="doctor" value="${ result}" scope="request" />
<sky:include page="com/panfeng/his/doctor/Doctor$Summary.jsp" />
