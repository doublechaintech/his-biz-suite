...
class PlatformDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, doctorListMetaInfo, profileListMetaInfo, registrationListMetaInfo, doctorCount, profileCount, registrationCount } = this.props.platform
...
{name: 'registrationList', displayName:'Registration',type:'registration',count:registrationCount,addFunction: true, role: 'registration', metaInfo: registrationListMetaInfo},
