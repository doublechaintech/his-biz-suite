...
public class ExpenseTypeForm extends BaseForm {
	...
	public ExpenseTypeForm periodFieldForDoctorSchedule(String parameterName, String initValue){
		FormField field =  periodFromDoctorSchedule(parameterName, initValue);		
		this.addFormField(field);
		return this;
	}
	
	public ExpenseTypeForm periodFieldForDoctorSchedule(String initValue){
		return periodFieldForDoctorSchedule("period",initValue);
	}
	public ExpenseTypeForm periodFieldForDoctorSchedule(){
