...
public class HisCheckerManager extends BaseManagerImpl {
	...
	protected void checkPriceOfExpenseItem(HisUserContext userContext, BigDecimal price, List<Message> messageList)
	{
	 	...
	 	checkMoneyAmount(price,0.00, 99.00,PRICE_OF_EXPENSE_ITEM, messageList); 		
	...
	protected void checkPeriodOfDoctorSchedule(HisUserContext userContext, String period, List<Message> messageList)
	{
		
	 	checkStringLengthRange(period,1, 8,PERIOD_OF_DOCTOR_SCHEDULE, messageList); 		
