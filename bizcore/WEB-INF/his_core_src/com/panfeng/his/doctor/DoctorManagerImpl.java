...
public class DoctorManagerImpl extends CustomHisCheckerManager implements DoctorManager {
 ...
 //--------------------------------------------------------------
	...
	*/
	...
	protected void checkParamsForAddingDoctorSchedule(HisUserContext userContext, String doctorId, String name, Date scheduleDate, String period, int available, BigDecimal price, String expenseTypeId, String departmentId,String [] tokensExpr) throws Exception{
	...
	{	
		...
		checkParamsForAddingDoctorSchedule(userContext,doctorId,name, scheduleDate, period, available, price, expenseTypeId, departmentId,tokensExpr);
		
		DoctorSchedule doctorSchedule = createDoctorSchedule(userContext,name, scheduleDate, period, available, price, expenseTypeId, departmentId);
	...
	protected void checkParamsForUpdatingDoctorScheduleProperties(HisUserContext userContext, String doctorId,String id,String name,Date scheduleDate,String period,int available,BigDecimal price,String [] tokensExpr) throws Exception {
	...
	public  Doctor updateDoctorScheduleProperties(HisUserContext userContext, String doctorId, String id,String name,Date scheduleDate,String period,int available,BigDecimal price, String [] tokensExpr) throws Exception
	{	
		checkParamsForUpdatingDoctorScheduleProperties(userContext,doctorId,id,name,scheduleDate,period,available,price,tokensExpr);
	...
	protected DoctorSchedule createDoctorSchedule(HisUserContext userContext, String name, Date scheduleDate, String period, int available, BigDecimal price, String expenseTypeId, String departmentId) throws Exception{
