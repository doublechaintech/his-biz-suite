package com.doublechaintech.his.utils;
...
public class BaseBizHelper {
	protected CustomHisUserContextImpl userContext;
	protected static final Map<String, Object> EO = new HashMap<>();
	protected Map<String, Object> cache;
	
	public CustomHisUserContextImpl getUserContext() {
		return userContext;
	}
	public void setUserContext(CustomHisUserContextImpl userContext) {
		this.userContext = userContext;
	}

	protected static <T extends BaseBizHelper> T _OF(CustomHisUserContextImpl ctx, Class<T> clazz) {
		return _OF(ctx, clazz, false);
	}
			
	protected static <T extends BaseBizHelper> T _OF(CustomHisUserContextImpl ctx,
