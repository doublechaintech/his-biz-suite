<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.doctorschedule.DoctorSchedule'%>
...
<c:set var="ownerBeanName" value="doctorSchedule" scope="request"/>
<c:set var="ownerClassName" value="DoctorSchedule" scope="request"/>
...
<div class="row">
	...
	<% DoctorSchedule result = (DoctorSchedule)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="doctorSchedule" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/his/doctorschedule/DoctorSchedule$Summary.jsp" />
