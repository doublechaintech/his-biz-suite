...
public class DoctorScheduleTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_DOCTOR,COLUMN_SCHEDULE_DATE,COLUMN_PERIOD,COLUMN_DEPARTMENT,COLUMN_AVAILABLE,COLUMN_PRICE,COLUMN_EXPENSE_TYPE,COLUMN_CREATE_TIME,COLUMN_UPDATE_TIME,COLUMN_HOSPITAL,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_DOCTOR,COLUMN_SCHEDULE_DATE,COLUMN_PERIOD,COLUMN_DEPARTMENT,COLUMN_AVAILABLE,COLUMN_PRICE,COLUMN_EXPENSE_TYPE,COLUMN_CREATE_TIME,COLUMN_UPDATE_TIME,COLUMN_HOSPITAL};
