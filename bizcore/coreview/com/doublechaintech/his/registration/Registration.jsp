<%@ page import='java.util.*,com.doublechaintech.his.*,com.doublechaintech.his.registration.Registration'%>
...
<sky:include page="com/doublechaintech/his/registration/Registration$Summary.jsp" />
	...
	<div class="row">
<c:set var="profile" value="${ result.patient}" scope="request" />
<sky:include page="com/doublechaintech/his/profile/Profile$Info.jsp" />

<c:set var="profile" value="${ result.register}" scope="request" />
<sky:include page="com/doublechaintech/his/profile/Profile$Info.jsp" />
