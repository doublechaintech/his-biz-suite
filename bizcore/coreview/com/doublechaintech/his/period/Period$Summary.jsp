...
<div class="col-xs-12 col-md-12 section">
	<b title="A Period"> 
		${userContext.localeMap['period']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['period.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
