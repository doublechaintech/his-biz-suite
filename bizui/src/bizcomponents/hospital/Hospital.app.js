...
class HospitalBizApp extends React.PureComponent {
    ...
    return (
      ...
      >
        <Menu.Item key="dashboard">
          <Link to={`/hospital/${this.props.hospital.id}/dashboard`}>
            <Icon type="dashboard" />
        ...
        <SubMenu
          ...
          title={
            <span>
              <Icon type="setting" />
              <span>{appLocaleName(userContext, 'Setting')}</span>
            </span>
          }
        >
          <Menu.Item key="profile">
            <Link to={`/hospital/${this.props.hospital.id}/permission`}>
              <Icon type="safety-certificate" />
              <span>{appLocaleName(userContext, 'Permission')}</span>
            </Link>
          </Menu.Item>
          <Menu.Item key="permission">
            <Link to={`/hospital/${this.props.hospital.id}/profile`}>
              <Icon type="cluster" />
              <span>{appLocaleName(userContext, 'Profile')}</span>
            </Link>
          </Menu.Item>
        </SubMenu>
      </Menu>
  ...
  getExpenseTypeSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: {
        type: '_hospital',
        id: state._hospital.id,
        referenceName: 'hospital',
        listName: 'expenseTypeList',
        ref: state._hospital,
  ...
  buildRouters = () => {
    ...
    const routers = [
      ...
      {
        path: '/hospital/:id/list/expenseTypeCreateForm',
        component: this.getExpenseTypeCreateForm(),
      },
      {
        path: '/hospital/:id/list/expenseTypeUpdateForm',
        component: this.getExpenseTypeUpdateForm(),
      },
      ...
      {
        path: '/hospital/:id/list/expenseItemCreateForm',
        component: this.getExpenseItemCreateForm(),
      },
      {
        path: '/hospital/:id/list/expenseItemUpdateForm',
      ...
      {
        path: '/hospital/:id/list/departmentCreateForm',
        component: this.getDepartmentCreateForm(),
      },
      {
        path: '/hospital/:id/list/departmentUpdateForm',
        component: this.getDepartmentUpdateForm(),
      },

      { path: '/hospital/:id/list/doctorScheduleList', component: this.getDoctorScheduleSearch() },
      {
        path: '/hospital/:id/list/doctorScheduleCreateForm',
        component: this.getDoctorScheduleCreateForm(),
      },
      {
        path: '/hospital/:id/list/doctorScheduleUpdateForm',
        ...
        <Header>
          <div className={styles.left}>
            ...
            <Link key={'__home'} to={'/home'} className={styles.breadcrumbLink}>
              <Icon type="home" />
              &nbsp;{appLocaleName(userContext, 'Home')}
            </Link>
